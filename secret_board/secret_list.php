...
<body>
      ...
      <!-- login -->
        ...
        <tbody>
            <tr>
                <td><?=$row['id']?></td>
                <td><a href="secret_detailview.php?id=<?=$row['id']?>"><?=$row['title']?></a></td>
                <td><?=$row['users_id']?></td>
                <td><?=$row['reg_time']?></td>
                <td><?=$row['hit']?></td>
                <td><?=$row['thump_up']?></td>
        ...
        <button type="button" onclick="location.href='./secret_regist.php'">글쓰기</button>
