    ...
    <!---------- header ---------->
            ...
            <a href="../home.php">홈</a>
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="./secret_list.php">익명게시판</a>
                    </div>
                </div>
                <div class="dropdown">
      ...
      <!-- login -->
        ...
        <?php
            ...
            // hit update
            $sql="UPDATE secret_board SET hit=hit+1 WHERE id = ".$id;
            $conn->query($sql);

            $sql="SELECT title, users_id, reg_time, hit, thump_up, contents FROM secret_board WHERE id = ".$id;
        ...
        <section>
            <div class="view_content_wrap">
                ...
                <div class="view_clear">
                    <button type="button" onclick="location.href='./secret_update.php?id=<?=$id?>'">수정</button>
                    <button type="button" onclick="location.href='./secret_deleteprocess.php?id=<?=$id?>'">삭제</button>
                    <button type="button" onclick="location.href='./secret_list.php'">목록</button>
                </div>
            </div>
