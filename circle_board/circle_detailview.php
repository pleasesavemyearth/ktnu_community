    ...
    <!---------- header ---------->
      ...
      <!-- login -->
        ...
        <?php
            ...
            // hit update
            $sql="UPDATE circle_board SET hit=hit+1 WHERE id = ".$id;
            $conn->query($sql);

            $sql="SELECT title, users_id, reg_time, hit, contents FROM circle_board WHERE id = ".$id;
        ...
        <section>
            <div class="view_content_wrap">
                ...
                <div class="view_clear">
                    <button type="button" onclick="location.href='./circle_update.php?id=<?=$id?>'">수정</button>
                    <button type="button" onclick="location.href='./circle_deleteprocess.php?id=<?=$id?>'">삭제</button>
                    <button type="button" onclick="location.href='./circle_list.php'">목록</button>
                </div>
            </div>
