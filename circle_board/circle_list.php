...
<body>
      ...
      <!-- login -->
        ...
        <tbody>
            <tr>
                <td><?=$row['id']?></td>
                <td><a href="circle_detailview.php?id=<?=$row['id']?>"><?=$row['title']?></a></td>
                <td><?=$row['users_id']?></td>
                <td><?=$row['reg_time']?></td>
                <td><?=$row['hit']?></td>
            </tr>
        ...
        <button type="button" onclick="location.href='./circle_regist.php'">글쓰기</button>
