    ...
    <!---------- header ---------->
      ...
      <!-- login -->
        ...
        <?php
            ...
            // hit update
            $sql="UPDATE help_board SET hit=hit+1 WHERE id = ".$id;
            $conn->query($sql);

            $sql="SELECT title, users_id, reg_time, hit, contents FROM help_board WHERE id = ".$id;
        ...
        <section>
            <div class="view_content_wrap">
                ...
                <div class="view_clear">
                    <button type="button" onclick="location.href='./help_update.php?id=<?=$id?>'">수정</button>
                    <button type="button" onclick="location.href='./help_deleteprocess.php?id=<?=$id?>'">삭제</button>
                    <button type="button" onclick="location.href='./help_list.php'">목록</button>
                </div>
            </div>
