...
<body>
            ...
            <a href="../home.php">홈</a>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="./help_list.php">문의사항/건의</a>
                    </div>
                </div>
        </div>
      ...
      <!-- login -->
        ...
        <tbody>
            <tr>
                <td><?=$row['id']?></td>
                <td><a href="help_detailview.php?id=<?=$row['id']?>"><?=$row['title']?></a></td>
                <td><?=$row['users_id']?></td>
                <td><?=$row['reg_time']?></td>
                <td><?=$row['hit']?></td>
            </tr>
        ...
        <button type="button" onclick="location.href='./help_regist.php'">글쓰기</button>
